...
const customOrderLabels: Record<CustomOrderStatus, { label: string; className: string }> = {
  ...
  waiting_flower_preparation: { label: 'Khách hàng chuẩn bị hoa', className: 'bg-orange-100 text-orange-800 border-orange-200' },
  waiting_flower_receipt: { label: 'Đang vận chuyển hoa từ khách', className: 'bg-teal-100 text-teal-800 border-teal-200' },

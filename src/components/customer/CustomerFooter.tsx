    ...
    <footer className="border-t bg-secondary/50">
      <div className="container py-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/products" className="text-body hover:text-primary transition-colors">Hộp hoa ép</Link></li>
              <li><Link to="/products" className="text-body hover:text-primary transition-colors">Đồ lưu niệm hoa ép</Link></li>
              <li><Link to="/custom-order" className="text-body hover:text-primary transition-colors">Đặt hàng Custom</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="mb-3 font-heading text-sm font-semibold text-heading">Theo dõi Dear Floral</h4>
            <ul className="space-y-2 text-sm">
        ...
        <div className="mt-8 border-t pt-6 text-center text-xs text-caption">
          © 2026 Dear Floral. Tất cả quyền được bảo lưu.
        </div>
      </div>
    </footer>
  );
